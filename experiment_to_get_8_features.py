...
user_rating_inTrain=np.zeros(shape=(6,9))
...
df = pd.read_csv("OUTPUT8.txt", sep='|',header=None ,names=['UserID','TrackId','AlbumId','ArtistId','Track','Genre1','Genre2','Genre3','Genre4','Genre5','Genre6','Genre7','Genre8'])
# np.savetxt('8_features.txt', df.values, fmt='%d')    
df.to_csv("8features.csv",index=None)
